			...
			<div class=" main-content-area">
				...
				<div class="summary">
					<div class="order-summary">
						...
						<p class="summary-info"><span class="title">Discount (<?php echo e(Session::get('coupon')['code']); ?>)<a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a></span><b class="index">-$<?php echo e($discount); ?></b></p>
						<p class="summary-info"><span class="title">Subtotal with Discount</span><b class="index">$<?php echo e($subtotalAfterDiscount); ?></b></p>
