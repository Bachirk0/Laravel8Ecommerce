...
<div class="container">
            ...
            <div class="wrap-product-detail">
                ...
                <div class="detail-info">
                    <div class="product-rating">
                        ...
                        <?php endif; ?>
                        <?php endfor; ?>
                        <a href="#" class="count-review">(<?php echo e($product->orderItems->where('rstatus',1)->count()); ?> commentaires)</a>
                    </div>
                    ...
                    <div class="quantity">
                        ...
                        <div class="quantity-input">
                            <input type="text" name="product-quatity" value="1" data-max="120" pattern="[0-9]*" wir:model="qty" >
                    ...
                    <div class="wrap-butons">
                        ...
                        <div class="wrap-btn">
                            ...
                            <a href="#" class="btn btn-compare">Ajouter</a>
                            <a href="#" class="btn btn-wishlist">Ajouter à la liste des souhaits</a>
                        </div>
                    </div>
                </div>
                <div class="advance-info">
                    <div class="tab-control normal">
                        ...
                        <a href="#add_infomation" class="tab-control-item">Information supplementaire</a>
                    ...
                    <div class="tab-contents">
                        ...
                        <div class="tab-content-item " id="add_infomation">
                            <table class="shop_attributes">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Dimentions</th><td class="product_dimensions">12 x 15 x 23 cm</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="tab-content-item " id="review">
                            ...
                            <div class="wrap-review-form">
                                ...
                                <div id="comments">
                                    <h2 class="woocommerce-Reviews-title"><?php echo e($product->orderitems->where('rstatus', 1)->count()); ?> Commentaire pour <span><?php echo e($product->name); ?></span></h2>
                                            ...
                                            <div id="comment-20" class="comment_container"> 
                                                ...
                                                <div class="comment-text">
                                                    <div class="star-rating">
                                                        <span class="width<?php echo e($orderItem->review->rating * 20); ?>percent">Evaluer <strong class="rating"><?php echo e($orderItem->review->rating); ?></strong> out of 5</span>
                                                    </div>
                                                    <p class="meta"> 
                                                        <strong class="woocommerce-review__author"><?php echo e($orderItem->order->user->name); ?></strong> 
                                                        <span class="woocommerce-review__dash">–</span>d
                                ...
                                <li class="product-item">
									<div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
											<a href="<?php echo e(route('product.details', ['slug'=> $p_product->slug])); ?>" title="<?php echo e($p_product->name); ?>" class="product-name"><span><?php echo e($p_product->name); ?></span></a>
	...
	<!--main area-->
<?php /**PATH /home/bachir/laravel8ecommerce/resources/views/livewire/details-component.blade.php ENDPATH**/ ?>