					...
					<div class="container">
						...
						<div class="topbar-menu right-menu">
							<ul>		
                                ...
                                <li class="menu-item menu-item-has-children parent" >
									<a title="My acount" href="#">my acount (<?php echo e(Auth::user()->name); ?>)<i class="fa fa-angle-down" aria-hidden="true"></i></a>
									<ul class="submenu curency" >
										<li class="menu-item" >
                                        ...
                                        <li class="menu-item">
											<a href="<?php echo e(route('admin.products')); ?>">All Product</a>
										</li>

										<li class="menu-item">
											<a title="Manage Home Slide"href="<?php echo e(route('admin.homeslider')); ?>">Manage Home Slider</a>
										</li>

										<li class="menu-item">
											<a title="Manage Home Categories"href="<?php echo e(route('admin.homecategories')); ?>">Manage Home Category</a>
										</li>
										...
										<li class="menu-item">
											<a title="All coupon"href="<?php echo e(route('admin.coupons')); ?>">All coupons</a>
										</li> 
...
} elseif ($_instance->childHasBeenRendered('7AxwoDM')) {
    $componentId = $_instance->getRenderedChildComponentId('7AxwoDM');
    $componentTag = $_instance->getRenderedChildComponentTagName('7AxwoDM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7AxwoDM');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('7AxwoDM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('R8QkrtV')) {
    $componentId = $_instance->getRenderedChildComponentId('R8QkrtV');
    $componentTag = $_instance->getRenderedChildComponentTagName('R8QkrtV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('R8QkrtV');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('R8QkrtV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('pRcYzBz')) {
    $componentId = $_instance->getRenderedChildComponentId('pRcYzBz');
    $componentTag = $_instance->getRenderedChildComponentTagName('pRcYzBz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pRcYzBz');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('pRcYzBz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
