    ...
    <div class="container">
        ...
        <div class="row">
           <?php if(Cart::instance('wishlist')->content()->count() > 0): ?>
                    ...
                    <div class="product product-style-3 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-wish">
                                <a href="#" wire:click.pevent="removeFromWishlist(<?php echo e($item->model->id); ?>)" ><i class="fa fa-heart fill-heart"></i></a>
            ...
            <?php else: ?>
            <h4>No itemin wishlist</h4>
            <?php endif; ?>
        </div>
    </div>
</main><?php /**PATH /home/bachir/laravel8ecommerce/resources/views/livewire/wishlist-component.blade.php ENDPATH**/ ?>