						...
						<div class="wrap-right">
							<div class="sort-item orderby ">
								<select name="orderby" class="use-chosen" wire:model="sorting">
									...
									<option value="price">Trier par prix: moins cher au plus cher</option>
									<option value="price-desc">Sort by price: plus cher au moins cher</option>
								</select>
							</div>
					...
					<div class="widget mercado-widget filter-widget brand-widget">
						...
						<div class="widget-content">
							<ul class="list-style vertical-list list-limited" data-show="6">
								...
								<li class="list-item default-hiden"><a class="filter-link " href="#">Accessoirs</a></li>
								<li class="list-item"><a data-label='Show less<i class="fa fa-angle-up" aria-hidden="true"></i>' class="btn-control control-show-more" href="#">Plus<i class="fa fa-angle-down" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</div><!-- brand widget-->
					...
					<div class="widget mercado-widget filter-widget price-filter">
						...
						<div class="widget-content">
							...
							<p>
								...
								<button class="filter-submit">Filtre</button>
							</p>
						</div>
					</div><!-- Price-->
							...
							<ul class="products">
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">12000 fcfa</span></div>
										</div>
									</div>
								</li>
								...
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											<a href="#" class="product-name"><span>Montrres Rolex</span></a>
								...
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											<a href="#" class="product-name"><span>Vetements </span></a>
