								...
								<div class="product product-style-3 equal-elem ">
									...
									<div class="product-info">
										...
										<div class="product-wish">
											...
											<a href="#" wire:click.pevent="removeFromWishlist({{$product->id}})" ><i class="fa fa-heart fill-heart"></i></a>
											@else
											<a href="#" wire:click.pevent="addToWishlist({{$product->id}},'{{$product->name}}',{{$product->regular_price}})"><i class="fa fa-heart"></i></a>
											@endif
										</div>
