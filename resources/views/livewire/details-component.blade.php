            ...
            <div class="wrap-product-detail">
                ...
                <div class="detail-info">
                    <div class="product-rating">
                        ...
                        @endif
                        @endfor
                        <a href="#" class="count-review">({{$product->orderItems->where('rstatus',1)->count()}} commentaires)</a>
                    </div>
                    ...
                    <div class="tab-contents">
                        ...
                        <div class="tab-content-item " id="review">
                            ...
                            <div class="wrap-review-form">
                                ...
                                <div id="comments">
                                    <h2 class="woocommerce-Reviews-title">{{$product->orderitems->where('rstatus', 1)->count()}} Commentaire pour <span>{{$product->name}}</span></h2>
