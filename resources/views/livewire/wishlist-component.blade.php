    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Liste des souhaits</span></li>
            </ul>
        </div>
        <style>
            .product-wish{
        ...
        <div class="row">
           @if(Cart::instance('wishlist')->content()->count() > 0)
                    ...
                    <div class="product product-style-3 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-wish">
                                <a href="#" wire:click.pevent="removeFromWishlist({{$item->model->id}})" ><i class="fa fa-heart fill-heart"></i></a>
            ...
            @else
            <h4>Pas de produits dans votre liste des souhaits</h4>
            @endif
        </div>
    </div>
</main>